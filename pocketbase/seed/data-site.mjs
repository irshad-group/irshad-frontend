...
export const faq = [
  ...
  ['Why is some content only available in one language?', 'لماذا يتوفر بعض المحتوى بلغة واحدة فقط؟', 'بۆچی هەندێک ناوەڕۆک تەنها بە یەک زمان بەردەستە؟',
    ...
    'تُترجم المحتويات تباعاً بعد مراجعتها، وحين لا تكون الترجمة جاهزة يُعرض النص الإنكليزي حتى لا يُخفى عنك شيء.',
  ...
  ['Can I download the official forms from here?', 'هل يمكنني تنزيل الاستمارات الرسمية من هنا؟', 'دەتوانم فۆرمە فەرمییەکان لێرەوە دابەزێنم؟',
    ...
    'نعم. عندما تنشر الدائرة استمارة، تُرفق بصفحة الإجراء ويمكن تنزيلها وطباعتها.',
  ...
  ['What should I do if a procedure page is wrong?', 'ماذا أفعل إذا كانت معلومات الإجراء خاطئة؟', 'ئەگەر زانیاریی ڕێکارێک هەڵە بوو چی بکەم؟',
    ...
    'استخدم استمارة الاتصال واذكر اسم الإجراء. تُدقَّق التصحيحات مع الدائرة قبل تحديث الصفحة.',
  ...
  ['Do the fees shown include all charges?', 'هل تشمل الرسوم المعروضة كل الأجور؟', 'ئایا ئەو کرێیانەی نیشان دراون هەموو تێچووەکان دەگرنەوە؟',
    ...
    'المبلغ المعروض هو الرسم الحكومي الأساس، وقد تُضاف الطوابع والاستمارات وأجور التوصيل مبلغاً بسيطاً في النافذة.',
  ...
  ['Are procedures the same in the Kurdistan Region?', 'هل الإجراءات نفسها في إقليم كردستان؟', 'ئایا ڕێکارەکان لە هەرێمی کوردستان هەمانن؟',
    ...
    'كثير منها كذلك، لكن بعضها تتولاه دوائر حكومة إقليم كردستان بمكاتب ورسوم خاصة، وتُعلَّم تلك المدخلات بوسم الإقليم.',
  ...
  ['Can someone else complete a procedure on my behalf?', 'هل يمكن لشخص آخر إنجاز المعاملة نيابة عني؟', 'دەکرێت کەسێکی تر لە جیاتی من ڕێکارەکە تەواو بکات؟',
    ...
    'غالباً نعم بوكالة مصدقة، إلا أن الخطوات البايومترية كالبصمة والصورة تتطلب حضور صاحب الطلب شخصياً.',
  ...
  ['How are comments and ratings moderated?', 'كيف تُدار التعليقات والتقييمات؟', 'لێدوان و هەڵسەنگاندنەکان چۆن بەڕێوە دەبرێن؟',
    ...
    'يراجع محرر كل تعليق وتقييم قبل ظهوره للعامة، وتُزال البيانات الشخصية والشكاوى ضد موظفين بأسمائهم.',
...
export const slider = [
  ...
  ['Renew your passport in five steps', 'جدّد جواز سفرك بخمس خطوات', 'پاسپۆرتەکەت بە پێنج هەنگاو نوێ بکەرەوە',
  ...
  ['Download the official forms', 'نزّل الاستمارات الرسمية', 'فۆرمە فەرمییەکان دابەزێنە',
  ...
  ['Available in English, Arabic and Kurdish', 'متاح بالإنكليزية والعربية والكردية', 'بە ئینگلیزی و عەرەبی و کوردی بەردەستە',
    'Switch language at any time from the header.', 'بدّل اللغة في أي وقت من أعلى الصفحة.', 'لە هەر کاتێکدا زمان لە سەرەوەی پەڕەکە بگۆڕە.',
    '/en/faq', '#8A5A1E'],
...
export const settings = [
  ...
  ['footer_note', 'Footer note', 'general', false,
    ...
    'إرشاد دليل معلوماتي. تأكد دائماً من الرسوم والمتطلبات لدى الدائرة المختصة.',
